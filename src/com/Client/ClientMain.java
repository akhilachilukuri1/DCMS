...
public class ClientMain {
    ...
    public static void main(String[] args) throws IOException, NotBoundException {
    	...
    	while(i!=0)
    	{
    		...
    		switch(choice)
    		{
    		case 1:System.out.println("Enter the first name of the teacher");
    				...
    				System.out.println(client.createTRecord(firstNameT, lastNameT, addressT, phoneT, specilizationT, locationT));
    			break;
    		case 2:System.out.println("Enter the first name of the student");
					...
					boolean status=br.readLine()=="active"?true:false;
					System.out.println("Enter the date");
					Date statusDate=new Date(br.readLine());
					System.out.println(client.createSRecord(firstNameS, lastNameS, coursesRegistered, status, statusDate));
    			break;
    		case 3:System.out.println(client.getRecordCounts());
    			break;
    		case 4:System.out.println("Enter the recordID");
