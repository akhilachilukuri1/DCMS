...
public class ServerImp implements ICenterServer {
	...
	public String editRecord(String recordID, String fieldname, String newvalue) {
		...
		if (type.equals("TR")) {
			edit_record_TR(recordID, fieldname, newvalue);
		}

		if (type.equals("SR")) {
			edit_record_SR(recordID, fieldname, newvalue);
		}
	...
	private void edit_record_SR(String recordID, String fieldname, String newvalue) {
	...
	private void edit_record_TR(String recordID, String fieldname, String newvalue) {
